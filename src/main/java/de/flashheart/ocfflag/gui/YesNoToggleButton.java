...
public class YesNoToggleButton extends JPanel implements ItemSelectable {
    ...
    public YesNoToggleButton(String yes, String no, boolean selectYes) {
        ...
        tbYes = new ColoredToggleButton(Tools.xx(yes), Colors.darkgreen, UIManager.getColor("ToggleButton.background"), Color.YELLOW, Color.gray);
        tbNo = new ColoredToggleButton(Tools.xx(no), Colors.darkred, UIManager.getColor("ToggleButton.background"), Color.YELLOW, Color.gray);
    ...
    public void setEnabled(boolean enabled) {
        ...
        Tools.setXEnabled(this, enabled);
    }
